    ...
    return SizedBox(
      child: Column(
        ...
        children: [
          ...
          Row(
            children: [
              Text("Agrizy",style: GoogleFonts.inter(fontWeight: FontWeight.w400,fontSize: 14,height: 1.5,color: const Color(0xFF152420)),),
              const SizedBox(width: 4,),
              const Icon(Icons.arrow_back,color:Color(0xFF9FA5A0),size: 17,),
              const SizedBox(width: 2.5,),
              Text("Keshav Industries",style: GoogleFonts.inter(fontWeight: FontWeight.w400,fontSize: 14,height: 1.5,color: const Color(0xFF78716C)),),
            ],
          ),
        ],
      ),
